...
A beginner may have been tempted to make \code{PMPolynomial} a
subclass of \code{Array} to spare the need for an instance
...
\input{Smalltalk/FunctionEvaluation/DhbPolynomial.tex}
\end{listing}
