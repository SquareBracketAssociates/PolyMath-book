...
with the box {\textbf LagrangeInterpolator} grayed.} The object
...
A final discussion should be made about the two methods \code{xPointAt:} and \code{yPointAt:}. In principle, there is no need for
...
\marginpar{Figure \ref{cls:interpolation} with the box {\textbf
