...
\end{verbatim}
 {\tt seeds := <\textsl an array containing the desired seeds\tt >}
\begin{verbatim}
 generators := seeds collect:
           [ :each | DhbCongruentialRandomNumberGenerator seed: each].
\end{verbatim}
\noindent\hskip 5ex{\tt <\textsl Here is where the various generators
are used\tt
>}\hfil \\
\hskip 5ex{\tt <index \textsl is the index of the desired series\tt
>}\hfil
\begin{verbatim}
