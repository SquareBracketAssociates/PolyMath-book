...
The reason for the split into two
...
The class \code{PMFixedStatisticalMoments} is a specialization of the class \code{PMStatisticalMoments} for a fixed number of
