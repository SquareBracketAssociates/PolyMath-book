...
\begin{flushright}
{\sl Qu'il n'y ait pas de réponse n'excuse pas l'absence de
...
\begin{listing}
\lcaption{Java implementation of the interface {\tt
OneVariableFunction}}
\label{lj:function}
...
\ref{sec:jnewton}.
\begin{listing}
\lcaption{Java implementation of a generic derivative evaluation}
\label{lj:derivative}
...
\begin{listing}
\lcaption{Smalltalk implementation of the polynomial class}
\label{ls:polynomial}
...
\begin{listing}
\lcaption{Method of class {\tt Number} related to polynomials}
...
\begin{listing}
\lcaption{Java implementation of the polynomial class}
\label{lj:polynomial}
...
\begin{listing}
\lcaption{Smalltalk implementation of the Error function}
...
\begin{listing}
\lcaption{Java implementation of the Error function (partial
listing)}
...
\begin{listing}
\lcaption{Smalltalk implementation of the gamma function}
\label{ls:gammafunc}
...
\begin{listing}
\lcaption{Java implementation of the gamma function}
\label{lj:gammafunc}
...
\begin{listing}
\lcaption{Smalltalk implementation of the beta function}
\label{ls:betafunc}
