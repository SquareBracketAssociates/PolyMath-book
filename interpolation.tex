...
\begin{flushright}
{\sl On ne peut prévoir les choses qu'après qu'elles sont
arrivées.}\footnote{One can predict things only after they have
occurred.}\\ Eugène Ionesco
\end{flushright}
...
\begin{listing} \lcaption{Smalltalk implementation of the Lagrange
interpolation}
\label{ls:lagrange}
...
\begin{listing} \lcaption{Java interface for point series}
...
points is required.
\begin{listing} \lcaption{A possible concrete implementation of the interface {\tt
PointSeries}}
\label{lj:curve}
...
separate method. Moreover, splitting the method would increase the
computing time.
\begin{listing} \lcaption{Java implementation of the Lagrange
interpolation}
\label{lj:lagrange}
...
\begin{listing} \lcaption{Smalltalk implementation of the Newton interpolation}
\label{ls:newtonint}
...
\begin{listing} \lcaption{Java implementation of the Newton interpolation}
\label{lj:newtonint}
...
\begin{listing} \lcaption{Smalltalk implementation of Neville's algorithm}
\label{ls:neville}
...
\begin{listing} \lcaption{Java implementation of Neville interpolation}
\label{lj:neville}
...
\begin{listing} \lcaption{Smalltalk implementation of Bulirsch-Stoer interpolation}
\label{ls:bustoer}
...
\begin{listing} \lcaption{Java implementation of Bulirsch-Stoer interpolation}
\label{lj:bustoer}
...
\begin{listing} \lcaption{Smalltalk implementation of cubic spline interpolation} \label{ls:spline}
...
\begin{listing} \lcaption{Java implementation of cubic spline
interpolation}
\label{lj:spline}
