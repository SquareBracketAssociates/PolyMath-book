...
parameters.
\begin{figure}
\center\psfig{figure=Figures/ExponentialDistribution.eps, width=12cm}
...
\begin{figure}
\center\psfig{figure=Figures/FisherTippettDistribution.eps, width=12cm}
...
of the parameters.
\begin{figure}
\center\psfig{figure=Figures/LogNormalDistribution.eps, width=12cm}
