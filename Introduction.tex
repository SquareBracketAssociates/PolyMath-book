...
\begin{listing}
\lcaption{Smalltalk code to find the machine precision}
...
\begin{listing}
\lcaption{Java code to find the machine precision}
...
\begin{listing}
\lcaption{Comparison of floating point numbers in Smalltalk}
\label{ls:fltcompare}
