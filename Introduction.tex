...
\begin{listing}
%  \caption{Smalltalk code to find the machine precision}
...
\end{listing}
\caption{Java code to find the machine precision}
\end{figure}
\begin{quote}
...
\end{listing}
\caption{Comparison of floating point numbers in Smalltalk}
\end{figure}
